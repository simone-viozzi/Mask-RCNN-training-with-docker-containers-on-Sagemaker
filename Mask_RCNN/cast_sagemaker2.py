...
if __name__ == "__main__":
	...
	if config.SAVE_MODEL:
		# if SAVE_MODEL is true the checkpoints are loaded as complete models
		print("ATTENTION: SAVE_MODEL IS ENABLED!, the checkpoints are loaeded and saved as complete model not as wheights!!")
		

	# TODO: va aggiunto il caricamento del modello completo dal checkpoint all'interno dell init del framework!!
